...
groups <- read.csv("./Randomization/development/Salman/2501.csv", sep = ";", header = TRUE)
# Two groups: mCherry and Gi-DREADD
treatment_groups <- c("mCherry", "Gi")
n_blocks <- data.frame(treatment = rep(treatment_groups, each = 12L))
...
write.csv(res, file = "./Randomization/development/Salman/2501_result.csv", quote = FALSE)
